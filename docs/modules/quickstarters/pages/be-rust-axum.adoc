...
* https://blog.rust-lang.org/2024/08/08/Rust-1.80.1.html[Rust 1.80.1]
...
The only missing piece required is to enable the `vendored` feature in the crate in your `Cargo.toml`:
