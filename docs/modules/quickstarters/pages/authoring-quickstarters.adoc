...
== Testing Quickstarters

Every quickstarter must include a complete end-to-end (e2e) test that exercises the generated project; these tests are executed using the testing framework provided in the ods-core/test project. See xref:quickstarters:quickstarters-automated-tests.adoc[Quickstarter automated tests] for additional details and guidelines.
