...
https://github.com/opendevstack/ods-quickstarters/tree/master/common/jenkins-agents/nodejs12-angular[Nodejs12-Angular builder agent] Jenkins builder agent.
