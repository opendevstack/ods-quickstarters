...
The quickstarter sets up two pods in OpenShift. The `ds-jupyter-lab` instance is routed through the https://catalog.redhat.com/software/containers/openshift4/ose-oauth-proxy/5cdb2133bed8bd5717d5ae64[OpenShift OAuth proxy] instance.
