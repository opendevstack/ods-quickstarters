...
When provisioning this quickstarter in the provisioning app a spring boot project based on version `2.7.1` will be generated and pushed to your git repository.
