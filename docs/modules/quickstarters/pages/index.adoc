...
Next to those, there is a https://github.com/opendevstack/ods-quickstarters/blob/2.x/README.md["blank" quickstarter] allowing to start from scratch, while still providing all the OCP resources / Jenkins / SonarQube conveniences described in the following sections.
